...
- For Vercel, set the project Root Directory to `apps/web`, set the Output Directory to `.vercel/output`, and keep source files outside the root directory enabled so the shared workspace packages resolve during builds.
